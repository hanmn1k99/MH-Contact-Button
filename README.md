...
> ⚠️ **Lưu ý quan trọng:** Nếu trang web của bạn đang sử dụng plugin tạo cache (như LiteSpeed Cache, WP Rocket,...), vui lòng thực hiện thao tác xóa cache (Purge/Clear Cache) sau khi lưu cấu hình để các thay đổi có hiệu lực ngay lập tức.
